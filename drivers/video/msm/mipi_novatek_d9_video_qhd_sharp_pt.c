...
static int mipi_video_novatek_sharp_qhd_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_video_novatek_sharp_qhd"))
		return 0;
	...
	ret = mipi_novatek_sharp_qhd_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_video_novatek_sharp_qhd_pt_init);
