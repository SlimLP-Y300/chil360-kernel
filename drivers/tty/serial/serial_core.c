...
extern void gpiosleep_outgoing_data(void);
extern void gpiosleep_uart_open(struct uart_port *uport);
//extern void gpiosleep_uart_close(struct uart_port *uport);
#endif
					...
					const unsigned char *buf, int count)
{
	...
	if (tty->name && !strcmp(tty->name, "ttyHS1"))
	{
		gpiosleep_outgoing_data();
	}
    #endif
